...
<script type="text/javascript">
    ...
    $("#filterParamLevel1").keyup(function(){
           // $("#paramLevel1 > ul").html("");
            ...
            CreateParamLevel1List($(this).attr('paramName'), "param_value","LIKE", $(this).val());
        ...
        function CreateParamLevel1List(param_name,filter_field,searchType,filter_value)
        {
             //alert(filter_value);
             $.ajax({
                    ...
                    //async: "false",
                    dataType: "html",
                    data: "filter_field=" + filter_field + "&param_name=" + param_name + "&search_type=" + searchType +
